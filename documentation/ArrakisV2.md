...
**restrictedMint** (address): if set to a non-zero address, only that address can call mint
...
- restrictedMint should be address(0) or else the msg.sender of the call.
