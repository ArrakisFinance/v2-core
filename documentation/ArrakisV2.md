...
**parameters** :
- pools : array of address representing pools that should be removed.
...
**parameters** : 
- burns (array of BurnLiquidity struct): list of object containing range and amount of liquidity that need to be burned.
- burnAmount : amount of Arrakis token that user want to burn.
- receiver : address that will receive amount0 of token0 and amount1 of token1 after the burn take place.
...
**parameters** :
- ranges : list of ranges that will be used during rebalance.
...
**parameters** :
- amount0 : amount of tokens0 that should be transfered to uniswap v3 pools.
- amount1 : amount of tokens1 that should be transfered to uniswap v3 pools.
...
**parameters** :
- feeTiers\_ : list of feeTier that match with uniswap v3 pools that need to be added.
- token0Addr\_ : address of token0.
- token1Addr\_ : address of token1.

**checks** : 
- check that for feeTiers, token0 and token1 we have corresponding pools in uniswap v3 factory.
- check that theses pools are not already whitelisted one.

##### \_addRanges

**parameters** :
- ranges\_ : list of ranges that need to be added.
- token0Addr\_ : address of token0.
- token1Addr\_ : address of token1.
...
**parameters** :
- ranges\_ : list of ranges that need to be removed.
